        ...
        <div class="row">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="user-info-mini">
                            ...
                            <?= date('d/m/Y', strtotime($user->birthdate)) ?> ( <?= $user->idade ?> anos) 
                        </div>
            ...
            <div class="column pl-5">
                ...
                <?php if ($user->id == $usuario->id): ?>
                    <?= $render('feed-editor', ['usuario' => $usuario]) ?>
                <?php endif; ?>
                ...
                <div class="feed-pagination">
                        <?php for($i=0; $i<$feed['totalPags']; $i++ ): ?>
                            <a class="<?= $i == $feed['pagAtual'] ? 'active' : '' ?>" href="<?=$base; ?>/perfil/<?= $user->id ?>?page=<?= $i ?>"><?=$i+1 ?></a>
                        <?php endfor; ?>
                </div>
            </div>
