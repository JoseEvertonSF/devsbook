        <aside class="mt-10">
            <nav>
                ...
                <a href="<?= $base ?>/perfil">
                    <div class="menu-item <?= $active == 'profile' ? 'active': '' ?>">
                        <div class="menu-item-icon">
                ...
                <a href="<?= $base ?>/amigos">
                    <div class="menu-item <?= $active == 'friends' ? 'active': '' ?>">
                        <div class="menu-item-icon">
                ...
                <a href="<?= $base ?>/fotos">
                    <div class="menu-item <?= $active == 'photos' ? 'active': '' ?>">
                        <div class="menu-item-icon">
                ...
                <a href="<?= $base ?>/config">
                    <div class="menu-item <?= $active == 'config' ? 'active': '' ?>m">
                        <div class="menu-item-icon">
