<div class="box feed-new">
    <div class="box-body">
        <div class="feed-new-editor m-10 row">
            ...
            <div class="feed-new-input-placeholder" contenteditable="true" placeholder="O que você está pensando, <?= $usuario->name ?> ?"></div>
            <div class="feed-new-photo">
                <img src="<?= $base ?>/assets/images/photo.png" />
                <input type="file" name="photo" class="feed-new-file" accept="image/png,image/jpg,image/jpef" />
            </div>
...
<script type="text/javascript">
    let feedInput = document.querySelector('.feed-new-input-placeholder');
